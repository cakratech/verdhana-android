...
import com.bcasekuritas.mybest.databinding.DialogInfoManyDevicesOtpBinding
...
@FragmentScoped
@AndroidEntryPoint
class DialogInfoManyDevicesOtp() : BaseBottomSheet<DialogInfoManyDevicesOtpBinding>(){

    @FragmentScoped
    override val binding: DialogInfoManyDevicesOtpBinding by autoCleaned { (DialogInfoManyDevicesOtpBinding.inflate(layoutInflater)) }
