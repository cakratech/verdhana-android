...
@FragmentScoped
@AndroidEntryPoint
class DialogShareStockFragment(
    private val isProfit: Boolean,
    private val stockCode: String,
    private val company: String,
    private val price: String,
    private val percentage: String
) : BaseBottomSheet<FragmentDialogShareBinding>() {

    @FragmentScoped
    override val binding: FragmentDialogShareBinding by autoCleaned { (FragmentDialogShareBinding.inflate(layoutInflater)) }
    ...
    private fun setupRecycler() {
        setupContent(stockCode, company, price, percentage)
    ...
    private fun setupContent(
        ...
        binding.tvPercentage.setTextColor(ContextCompat.getColor(requireContext(), if (isProfit) R.color.textUpHeader else R.color.textDownHeader))
    ...
    private fun loadData() {
        binding.baseShare.toBitmap {
            val uri = saveBitmapToCache(requireContext(), it)
//            val linkSaham = "https://${resources.getString(R.string.deep_link)}/stock-detail/$stockCode"

            val txtCaption =
//                "Hey, take a look at $stockCode today! \n" +
//                    "$linkSaham \n" +
//                    "\n" +
