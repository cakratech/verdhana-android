...
class PriceAlertAdapter (
    val context: Context,
    val onClickBtnOption: OnClickAnyInt,
    val urlIcon: String
): RecyclerView.Adapter<PriceAlertAdapter.ItemViewHolder>(), ShowDropDown by ShowDropDownImpl() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        ...
        return ItemViewHolder(ItemPriceAlertBinding.inflate(inflater, parent, false))
    }
    ...
    inner class ItemViewHolder(
        val binding: ItemPriceAlertBinding
