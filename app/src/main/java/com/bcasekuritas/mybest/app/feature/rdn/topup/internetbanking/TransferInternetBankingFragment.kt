package com.bcasekuritas.mybest.app.feature.rdn.topup.internetbanking
...
import com.bcasekuritas.mybest.databinding.FragmentTransferInternetBankingBinding
...
@FragmentScoped
@AndroidEntryPoint
class TransferInternetBankingFragment :
    BaseFragment<FragmentTransferInternetBankingBinding, TransferInternetBankingViewModel>(), OnClickStr {

    @FragmentScoped
    override val bindingVariable: Int = BR.vmInternetBanking
    override val viewModel: TransferInternetBankingViewModel by viewModels()
    override val binding: FragmentTransferInternetBankingBinding by autoCleaned {
        (FragmentTransferInternetBankingBinding.inflate(
            layoutInflater
        ))
    }
    ...
    override fun setupAdapter() {
        super.setupAdapter()
        binding.rcvTransferInternetBanking.layoutManager = LinearLayoutManager(requireActivity())
        binding.rcvTransferInternetBanking.setHasFixedSize(true)
        binding.rcvTransferInternetBanking.adapter = transferMBankingAdapter
    }
