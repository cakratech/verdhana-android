...
class CustomQtyAdjusterPriceAlert (context: Context, attrs: AttributeSet) : ConstraintLayout(context, attrs) {

    private val binding =
        CustomQtyAdjusterBorderBinding.inflate(LayoutInflater.from(context), this, true)
    var listener: qtyAdjusterClickListener? = null
...
//        EditTextUtils.disallowFirstZero(binding.edtValue)
        ...
        binding.edtValue.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                binding.edtValue.setSelection(formattedText.length)
...
interface qtyAdjusterClickListener{
    fun onMinusClick()
    fun onPlusClick()
}